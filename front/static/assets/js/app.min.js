...
("undefined" != typeof window ? window : this, function (T, e) {
	...
	(C.fn.init = function (e, t, n) {
		...
		return (r = x.getElementById(i[2])) && (this[0] = r, this.length = 1),
		this
	}).prototype = C.fn,
	k = C(x);
						...
						e = function () {
							...
							if (!(r < l)) {
								if ((e = s.apply(n, i)) === o.promise())
									...
									y(t) ? a ? t.call(e, u(l, o, R, a), u(l, o, q, a)) : (l++, t.call(e, u(l, o, R, a), u(l, o, q, a), u(l, o, R, o.notifyWith))) : (s !== R && (n = void 0, i = [e]), (a || o.resolveWith)(n, i))
								}
							},
							t = a ? e : function () {
								try {
									...
									l <= r + 1 && (s !== q && (n = void 0, i = [e]), o.rejectWith(n, i))
								}
							};
	...
	C.Event = function (e, t) {
		...
		e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Ce : Se, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e,
		t && C.extend(this, t),
	...
	C.each({
		...
		C.event.special[e] = {
			...
			handle: function (e) {
				...
				n = e.relatedTarget,
				i = e.handleObj;
				return n && (n === this || C.contains(this, n)) || (e.type = i.origType, t = i.handler.apply(this, arguments), e.type = r),
				t
			}
		}
	}),
		...
		if (f && (t = (e = we(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
			...
			if (a)
				for (u = s[s.length - 1].ownerDocument, C.map(s, Pe), c = 0; c < a; c++)
					l = s[c], pe.test(l.type || "") && !X.access(l, "globalEval") && C.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
	...
	function Ue(e, t, n) {
		...
		s,
		a = e.style;
		return (n = n || Fe(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || oe(e) || (s = C.style(e, t)), !v.pixelBoxStyles() && We.test(s) && Be.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)),
		void 0 !== s ? s + "" : s
	}
	function ze(e, t) {
		return {
	...
	function tt(e, t, n) {
		...
		return (!v.boxSizingReliable() && r || "auto" === s || !parseFloat(s) && "inline" === C.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === C.css(e, "boxSizing", !1, i), (o = a in e) && (s = e[a])),
	...
	C.extend({
		...
		style: function (e, t, n, i) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				...
				null != n && n == n && ("number" !== o || l || (n += r && r[3] || (C.cssNumber[a] ? "" : "px")), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n))
			}
		},
	...
	function ht(o, e, t) {
		...
		for (!function (e, t) {
			...
			for (n in e)
				...
				(c, u.opts.specialEasing); i < r; i++)if (n = ht.prefilters[i].call(u, o, c, u.opts))
	...
	C.fn.extend({
		...
		stop: function (r, e, o) {
			...
			return "string" != typeof r && (o = e, e = r, r = void 0),
...
C.fn.extend({
	...
	C.extend(C.event, {
		trigger: function (e, t, n, i) {
			...
			if (o = f = s = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !Et.test(h + C.event.triggered) && (-1 < h.indexOf(".") && (h = (p = h.split(".")).shift(), p.sort()), l = h.indexOf(":") < 0 && "on" + h, (e = e[C.expando] ? e : new C.Event(h, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), c = C.event.special[h] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
				...
				return e.type = h,
				i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !V(n) || l && y(n[h]) && !b(n) && ((s = n[l]) && (n[l] = null), C.event.triggered = h, e.isPropagationStopped() && f.addEventListener(h, Tt), n[h](), e.isPropagationStopped() && f.removeEventListener(h, Tt), C.event.triggered = void 0, s && (n[l] = s)),
				e.result
			}
		},
	...
	v.createHTMLDocument = ((Kt = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Kt.childNodes.length),
...
(this, function (e, p) {
		...
		e._addTouchEventListeners = function () {
			...
			if (this._touchSupported) {
				...
				i = function (e) {
					...
					n._handleSwipe(),
					"hover" === n._config.pause && (n.pause(), n.touchTimeout && clearTimeout(n.touchTimeout), n.touchTimeout = setTimeout(function (e) {
								return n.cycle(e)
		...
		modifiers: {
			...
			arrow: {
				...
				fn: function (e, t) {
					...
					e.arrowElement = i,
					e.offsets.arrow = (ze(n = {}, f, Math.round(b)), ze(n, d, ""), n),
					e
				},
				element: "[x-arrow]"
			},
		...
		return Ue(o, [{
					...
					value: function () {
						return function () {
							...
							rt(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"), this.popper.style.position = "", this.popper.style.top = "", this.popper.style.left = "", this.popper.style.right = "", this.popper.style.bottom = "", this.popper.style.willChange = "", this.popper.style[ot("transform")] = ""),
	...
	Yt = function () {
		...
		e.show = function () {
			if (!(this._element.disabled || p(this._element).hasClass(Nt) || p(this._menu).hasClass(It))) {
				...
				p(n).trigger(t),
				t.isDefaultPrevented() || (p(this._menu).toggleClass(It), p(n).toggleClass(It).trigger(p.Event(Dt.SHOWN, e)))
			}
		},
		e.hide = function () {
			if (!this._element.disabled && !p(this._element).hasClass(Nt) && p(this._menu).hasClass(It)) {
				...
				n = u._getParentFromElement(this._element);
				p(n).trigger(t),
				t.isDefaultPrevented() || (p(this._menu).toggleClass(It), p(n).toggleClass(It).trigger(p.Event(Dt.HIDDEN, e)))
			}
		},
		e.dispose = function () {
		...
		e._getPlacement = function () {
			...
			t = Ut;
			return e.hasClass(kt) ? (t = Ft, p(this._menu).hasClass(jt) && (t = Bt)) : e.hasClass(Ot) ? t = Qt : e.hasClass(Lt) ? t = $t : p(this._menu).hasClass(jt) && (t = zt),
			t
		},
				...
				for (var t = [].slice.call(document.querySelectorAll(Pt)), n = 0, i = t.length; n < i; n++) {
					...
					if (e && "click" === e.type && (s.clickEvent = e), o) {
						...
						if (p(r).hasClass(It) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(r, e.target))) {
							...
							p(r).trigger(l),
							l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), t[n].setAttribute("aria-expanded", "false"), p(a).removeClass(It), p(r).removeClass(It).trigger(p.Event(Dt.HIDDEN, s)))
						}
					}
				}
		},
	...
	mn = function () {
		...
		e.show = function (e) {
			...
			if (!this._isShown && !this._isTransitioning) {
				...
				this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(nn.CLICK_DISMISS, hn, function (e) {
						return t.hide(e)
	...
	Un = function () {
		...
		e._enter = function (e, t) {
			...
			p(t.getTipElement()).hasClass(Pn) || t._hoverState === On ? t._hoverState = On : (clearTimeout(t._timeout), t._hoverState = On, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function () {
		...
		e._leave = function (e, t) {
			...
			t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = Ln, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function () {
	...
	Ti = function () {
		...
		e._activate = function (t) {
			...
			n.hasClass(fi) ? (n.closest(yi).find(_i).addClass(di), n.addClass(di)) : (n.addClass(di), n.parents(pi).prev(gi + ", " + vi).addClass(di), n.parents(pi).prev(mi).children(gi).addClass(di)),
		...
		slimScroll: function (S) {
			...
			return this.each(function () {
				...
				if (d.parent().hasClass(A.wrapperClass)) {
					...
					var v,
					y = D(u).addClass(A.railClass).css({
							width: A.size,
							height: "100%",
							position: "absolute",
							top: 0,
					...
					"bottom" === A.start ? (b.css({
						...
						}), E(0, !0)) : "top" !== A.start && (E(D(A.start).position().top, null, !0), A.alwaysVisible || b.hide()),
					v = this,
				...
				function x() {
					if (T(), clearTimeout(n), a == ~~a) {
						...
						f = !1;
					l = a,
					s >= d.outerHeight() ? f = !0 : (b.stop(!0, !0).fadeIn("fast"), A.railVisible && y.stop(!0, !0).fadeIn("fast"))
				}
				function C() {
		...
		return e.init = function () {
			...
			e.find(s.parentTrigger).children(s.triggerElement).on(c.CLICK_DATA_API, function (e) {
				...
				if ("true" !== t.attr("aria-disabled")) {
					...
					n.hasClass(f) ? (t.attr("aria-expanded", "false"), o.removeActive(n)) : (t.attr("aria-expanded", "true"), o.setActive(n), s.toggle && (o.removeActive(i), r.attr("aria-expanded", "false"))),
...
("object" == typeof global ? global : this, function () {
	...
	var h = {
		...
		show: function (e, t, n) {
			...
			o = 0,
			s = 0;
			s = 0 <= (s = "touches" in e && e.touches.length ? (o = e.touches[0].pageY - r.top, e.touches[0].pageX - r.left) : (o = e.pageY - r.top, e.pageX - r.left)) ? s : 0,
			o = 0 <= o ? o : 0;
		...
		hide: function (e, t) {
			for (var n = (t = t || this).getElementsByClassName("waves-rippling"), i = 0, r = n.length; i < r; i++)
				o(e, t, n[i]);
			a && (t.removeEventListener("touchend", h.hide), t.removeEventListener("touchcancel", h.hide)),
	...
	return t.init = function (e) {
		...
		a && (t.addEventListener("touchstart", n, !1), t.addEventListener("touchcancel", u.registerEvent, !1), t.addEventListener("touchend", u.registerEvent, !1)),
	...
	n.prototype.refresh = function () {
		...
		for (var r in this.handleScroll(), e = {
			...
			for (var s in this.waypoints[r]) {
				...
				"function" == typeof d ? d = d.apply(f) : "string" == typeof d && (d = parseFloat(d), -1 < f.options.offset.indexOf("%") && (d = Math.ceil(o.contextDimension * d / 100))),
				a = o.contextScroll - o.contextOffset,
				f.triggerPoint = Math.floor(p + a - d),
				l = h < o.oldScroll,
				u = f.triggerPoint >= o.oldScroll,
				c = !l && !u,
				!g && (l && u) ? (f.queueTrigger(o.backward), i[f.group.id] = f.group) : !g && c ? (f.queueTrigger(o.forward), i[f.group.id] = f.group) : g && o.oldScroll >= f.triggerPoint && (f.queueTrigger(o.forward), i[f.group.id] = f.group)
			}
		}
