...
export const getters = {
    ...
    checkActions: state => action => {
        return state.auth.user.actions.includes(action);
    },

    getActions(state) {
        return state.auth.user.actions;
    },
    ...
    enumCustomerStatus(state) {
        return state.customer.enumCustomerStatus;
    },

    enumOrderStatus(state) {
        return state.purchase.enumOrderStatus;
    },

    enumInsuranceStatus(state) {
        return state.insurance.enumInsuranceStatus;
    },

    enumProfile(state) {
        return state.insurance.enumProfile;
    },

    enumIntentionStatus(state) {
        return state.intention.enumIntentionStatus;
    },

    regions(state) {
        return state.settings.getRegions;
    },

    currencies(state) {
        return state.settings.getCurrencies;
    },
